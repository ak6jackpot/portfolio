var NewComponent = React.createClass({
  render: function () {
    return (
      <div>
        <link rel="pingback" href="https://eat-curious.com/xmlrpc.php" />
        <link
          rel="icon"
          type="image/x-icon"
          href="https://eat-curious.com/wp-content/themes/eat-curious/img/favicon.ico"
        />
        ...
        />
        <meta name="keywords" content="Eat Curious" />
        <meta name="copyright" content="Eat Curious" />
        <meta name="publisher" content="Eat Curious" />
        ...
        <link rel="canonical" href="https://eat-curious.com/" />
        <meta property="og:locale" content="en_US" />
        <meta property="og:type" content="website" />
        <meta property="og:title" content="Eat Curious | Meat free your mind" />
        <meta property="og:url" content="https://eat-curious.com/" />
        <meta property="og:site_name" content="Eat Curious" />
        <meta
          property="article:modified_time"
          content="2023-07-21T21:54:12+00:00"
        />
        <meta
          property="og:image"
          content="https://eat-curious.com/wp-content/uploads/2023/03/home-51.png"
        />
        ...
        <link
          ...
          href="https://eat-curious.com/wp-includes/css/dist/block-library/style.min.css?ver=6.4.3"
          type="text/css"
          media="all"
        />
        <style
        ...
        <link
          rel="stylesheet"
          id="styles-css"
          href="https://eat-curious.com/wp-content/themes/eat-curious/style.css?ver=1676387257"
          type="text/css"
          media="all"
        />
        <link
          rel="stylesheet"
          id="dflip-style-css"
          href="https://eat-curious.com/wp-content/plugins/3d-flipbook-dflip-lite/assets/css/dflip.min.css?ver=2.2.32"
          type="text/css"
          media="all"
        />
        <link
          rel="https://api.w.org/"
          href="https://eat-curious.com/wp-json/"
        />
        <link
          rel="alternate"
          type="application/json"
          href="https://eat-curious.com/wp-json/wp/v2/pages/100"
        />
        <link
          rel="EditURI"
          type="application/rsd+xml"
          title="RSD"
          href="https://eat-curious.com/xmlrpc.php?rsd"
        />
        <meta name="generator" content="WordPress 6.4.3" />
        <link rel="shortlink" href="https://eat-curious.com/" />
        <link
          rel="alternate"
          type="application/json+oembed"
          href="https://eat-curious.com/wp-json/oembed/1.0/embed?url=https%3A%2F%2Feat-curious.com%2F"
        />
        <link
          rel="alternate"
          type="text/xml+oembed"
          href="https://eat-curious.com/wp-json/oembed/1.0/embed?url=https%3A%2F%2Feat-curious.com%2F&format=xml"
        />
        ...
        <nav className="nav" role="navigation">
          <div className="nav__content full">
            <ul
              ...
              className="nav__desktop nav__desktop--left"
            >
              <li
                id="menu-item-250"
                className="menu-item menu-item-type-custom menu-item-object-custom current-menu-item current_page_item menu-item-250"
              >
              ...
              <li
                id="menu-item-330"
                className="menu-item menu-item-type-post_type_archive menu-item-object-products menu-item-330"
              >
                <a href="https://eat-curious.com/products/">Products</a>
              </li>
            </ul>{" "}
            <a
              className="site-logo"
            ...
            <ul
              id="menu-desktop-right"
              className="nav__desktop nav__desktop--right"
            >
              <li
                id="menu-item-227"
                className="menu-item menu-item-type-custom menu-item-object-custom current-menu-item current_page_item menu-item-227"
              >
              ...
              <li
                id="menu-item-19"
                className="button menu-item menu-item-type-post_type menu-item-object-page menu-item-19"
              >
                <a href="https://eat-curious.com/contact/">Contact Us</a>
              </li>
            </ul>{" "}
            <ul id="menu-mobile" className="nav__mobile">
              <li
                id="menu-item-329"
                className="menu-item menu-item-type-post_type_archive menu-item-object-products menu-item-329"
              >
                <a href="https://eat-curious.com/products/">Products</a>
              </li>
              <li
              ...
              >
                <a href="https://eat-curious.com/contact/">Contact</a>
              </li>
            </ul>{" "}
            <button className="nav__icon" title="Menu">
              <div>
                <span />
                <span />
                <span />
            ...
            <ul className="icon-list">
              <li>
                <a
                  className="icon-list__instagram"
                  href="https://www.instagram.com/eat_curious/"
                  target="_blank"
                  rel="nofollow"
                >
                  Instagram
              ...
              <li>
                <a
                  className="icon-list__facebook"
                  href="https://www.facebook.com/eatcurious/"
                  target="_blank"
                >
                  Facebook
                </a>
        ...
        <header className="intro" data-watch="true">
          <div className="full">
            ...
            <div className="intro__image noselect appear delay">
              <span className="squiggle squiggle1" />
              <span className="squiggle squiggle2" />
              <span className="squiggle squiggle3" />
              <picture>
                <source
                  srcSet="https://eat-curious.com/wp-content/uploads/2023/07/Afro-Fusion-Spice-Bowl.png"
                  media="(resolution: 192dpi) and (min-width:1024px)"
                />
                <source
                  srcSet="https://eat-curious.com/wp-content/uploads/2023/07/Afro-Fusion-Spice-Bowl-1024x1024.png"
                  media="(min-width:768px)"
                />
                <img
                  src="https://eat-curious.com/wp-content/uploads/2023/07/Afro-Fusion-Spice-Bowl-473x473.png"
                  alt="burger"
                />
              </picture>
            </div>
            <h1 className="intro__title2 noselect appear delay">Your Mind</h1>
          </div>
        </header>
        <main id="main" className="site-main" role="main">
          ...
          <div className="carousel carousel--logos">
            <div className="carousel__tape">
              ...
              <span>
                <img
                  src="https://eat-curious.com/wp-content/uploads/2023/02/home-45-473x317.png"
                  alt="Home 49"
                />
              </span>
              <span>
                <img
                  src="https://eat-curious.com/wp-content/uploads/2023/02/home-47-473x164.png"
                  alt="Home 51"
                />
              </span>
              <span>
                <img
                  src="https://eat-curious.com/wp-content/uploads/2023/02/home-48-473x373.png"
                  alt="Home 52"
                />
              </span>
              <span>
                <img
                  src="https://eat-curious.com/wp-content/uploads/2023/02/home-50-473x334.png"
                  alt="Home 54"
                />
              </span>
              <span>
                <img
                  src="https://eat-curious.com/wp-content/uploads/2023/05/home-52-473x334.png"
                  alt="Home 56"
                />
              </span>
              <span>
                <img
                  src="https://eat-curious.com/wp-content/uploads/2023/05/home-53-473x266.png"
                  alt="Home 57"
                />
              </span>
              <span>
          ...
          <div className data-watch="true" />
          <section id="about" className="text-block full" data-watch="true">
            <div className="text-block__half hide-desk appear delay">
              <h3>Curious... by name, by nature</h3>
            </div>
            <div className="text-block__half text-block__half--illustration appear delay">
              <img
                width={1024}
                height={1024}
                ...
                decoding="async"
                fetchpriority="high"
                srcSet="https://eat-curious.com/wp-content/uploads/2022/12/home-3.svg 300w, https://eat-curious.com/wp-content/uploads/2022/12/home-3.svg 473w, https://eat-curious.com/wp-content/uploads/2022/12/home-3.svg 1024w, https://eat-curious.com/wp-content/uploads/2022/12/home-3.svg 1536w, https://eat-curious.com/wp-content/uploads/2022/12/home-3.svg 2048w"
                sizes="(max-width: 1024px) 100vw, 1024px"
              />{" "}
            </div>
            <div className="text-block__half appear delay">
              <h3 className="hide-tab">Curious... by name, by nature</h3>
              <p>
          ...
          <div className=" nav-dark" data-watch="true" />
          <section className="text-block full nav-dark" data-watch="true">
            <div className="text-block__half hide-desk appear delay">
              <h3>Inspiring good through tasty goodness</h3>
            </div>
            <div className="text-block__half text-block__half--illustration appear delay">
              <img
                width={1024}
                height={1024}
                src="https://eat-curious.com/wp-content/uploads/2022/12/home-5.svg"
                className="attachment-large size-large"
                alt="Home 3"
                decoding="async"
                srcSet="https://eat-curious.com/wp-content/uploads/2022/12/home-5.svg 300w, https://eat-curious.com/wp-content/uploads/2022/12/home-5.svg 473w, https://eat-curious.com/wp-content/uploads/2022/12/home-5.svg 1024w, https://eat-curious.com/wp-content/uploads/2022/12/home-5.svg 1536w, https://eat-curious.com/wp-content/uploads/2022/12/home-5.svg 2048w"
                sizes="(max-width: 1024px) 100vw, 1024px"
              />{" "}
            </div>
            <div className="text-block__half appear delay">
              <h3 className="hide-tab">
          ...
          <section className="text-block full nav-dark" data-watch="true">
            ...
            <div className="text-block__half text-block__half--illustration appear delay">
              <img
                width={1024}
                height={1024}
                src="https://eat-curious.com/wp-content/uploads/2022/12/home-7.svg"
                className="attachment-large size-large"
                alt="Home 11"
                decoding="async"
                srcSet="https://eat-curious.com/wp-content/uploads/2022/12/home-7.svg 300w, https://eat-curious.com/wp-content/uploads/2022/12/home-7.svg 473w, https://eat-curious.com/wp-content/uploads/2022/12/home-7.svg 1024w, https://eat-curious.com/wp-content/uploads/2022/12/home-7.svg 1536w, https://eat-curious.com/wp-content/uploads/2022/12/home-7.svg 2048w"
                sizes="(max-width: 1024px) 100vw, 1024px"
              />{" "}
            </div>
            <div className="text-block__half appear delay">
              <h3 className="hide-tab">Powered by positivity</h3>
              <p>
                We’re not crusading or going up against an industry. We’re for;
                for flavour, for fun, for what’s possible.
              </p>
            </div>
          </section>
          <div className data-watch="true" />
          <section className="text-block full" data-watch="true">
            <div className="text-block__half hide-desk appear delay">
              <h3>Flavoursome food for everyone</h3>
            </div>
            <div className="text-block__half text-block__half--illustration appear delay">
              <img
                width={1024}
                height={1024}
                src="https://eat-curious.com/wp-content/uploads/2022/12/home-4.svg"
                className="attachment-large size-large"
                alt="Home 2"
                decoding="async"
                srcSet="https://eat-curious.com/wp-content/uploads/2022/12/home-4.svg 300w, https://eat-curious.com/wp-content/uploads/2022/12/home-4.svg 473w, https://eat-curious.com/wp-content/uploads/2022/12/home-4.svg 1024w, https://eat-curious.com/wp-content/uploads/2022/12/home-4.svg 1536w, https://eat-curious.com/wp-content/uploads/2022/12/home-4.svg 2048w"
                sizes="(max-width: 1024px) 100vw, 1024px"
              />{" "}
            </div>
            <div className="text-block__half appear delay">
              <h3 className="hide-tab">Flavoursome food for everyone</h3>
              <p>
          ...
          <section className="features full nav-dark" data-watch="true">
            <h4 className="appear">
              Features &amp; <br />
              Benefits
            </h4>
            <div className="features__half appear delay">
              ...
              <h5 className="sub2">Plant based</h5>
            ...
            <div className="features__half appear delay">
              ...
              <h5 className="sub2">Real ingredients</h5>
              <p>
                If we don’t know exactly what an ingredient is, we don’t include
                it.
              </p>
            </div>
            <div className="features__half appear delay">
              ...
              <h5 className="sub2">unreal texture</h5>
            ...
            <div className="features__half appear delay">
              ...
              <h5 className="sub2">Bland is banned</h5>
              <p>Foodies unite, because here flavour rules.</p>
            </div>
          </section>
          <div className="nav-dark" data-watch="true" />
          <section className="tiles full" data-watch="true">
            <div className="hidden">
              ...
              >
                <g clipPath="url(#clip0_587_15588)">
                  <path
                ...
                <defs>
                  <clipPath id="clip0_587_15588">
                    <rect width={1224} height={312} fill="white" />
                  </clipPath>
                </defs>
              </svg>
            </div>
            <div className="tiles__wrapper">
              <article
                className="tile appear delay"
                style={{ backgroundColor: "#1ABE71" }}
              >
                <div className="tile__content">
                  <h4>
                    <a href="https://eat-curious.com/products/pieces/">
                      Curious Pieces
                    </a>
                  </h4>
                  <h4>
                ...
                <div className="tile__track">
                  <a
                    href="https://eat-curious.com/products/pieces/"
                    className="tile__image"
                  >
                    <div className="tile__format">
                      <picture>
                        <source
                          srcSet="https://eat-curious.com/wp-content/uploads/2023/02/pieces-11.png"
                          media="(resolution: 192dpi) and (min-width:1024px)"
                        />
                        <source
                          srcSet="https://eat-curious.com/wp-content/uploads/2023/02/pieces-11-1024x1024.png"
                          media="(resolution: 192dpi) and (min-width:600px)"
                        />
                        <source
                          srcSet="https://eat-curious.com/wp-content/uploads/2023/02/pieces-11-768x768.png"
                        ...
                        <img
                          width="100%"
                          height="100%"
                          src="https://eat-curious.com/wp-content/uploads/2023/02/pieces-11-300x300.png"
                          alt="Pieces 11"
                        />
                      </picture>
                    </div>
              ...
              >
                <div className="tile__content">
                  <h4>
                    <a href="https://eat-curious.com/products/mince/">
                      Curious Mince
                    </a>
                  </h4>
                  <h4>
                ...
                <div className="tile__track">
                  <a
                    href="https://eat-curious.com/products/mince/"
                    className="tile__image"
                  >
                    <div className="tile__format">
                      <picture>
                        <source
                          srcSet="https://eat-curious.com/wp-content/uploads/2023/02/mince-10.png"
                          media="(resolution: 192dpi) and (min-width:1024px)"
                        />
                        <source
                          srcSet="https://eat-curious.com/wp-content/uploads/2023/02/mince-10-1024x1024.png"
                          media="(resolution: 192dpi) and (min-width:600px)"
                        />
                        <source
                          srcSet="https://eat-curious.com/wp-content/uploads/2023/02/mince-10-768x768.png"
                          media="(resolution: 192dpi)"
                        />
                        <source
                          srcSet="https://eat-curious.com/wp-content/uploads/2023/02/mince-10-768x768.png"
                        ...
                        <img
                          width="100%"
                          height="100%"
                          src="https://eat-curious.com/wp-content/uploads/2023/02/mince-10-300x300.png"
                          alt="Mince 10"
                        />
                      </picture>
                    </div>
              ...
              >
                <div className="tile__content">
                  <h4>
                    <a href="https://eat-curious.com/products/negg/">
                      Curious Negg
                    </a>
                  </h4>
                  <h4>
                ...
                <div className="tile__track">
                  <a
                    href="https://eat-curious.com/products/negg/"
                    className="tile__image"
                  >
                    <div className="tile__format">
                      <picture>
                        <source
                          srcSet="https://eat-curious.com/wp-content/uploads/2023/07/negg-e1690228015512.png"
                          media="(resolution: 192dpi) and (min-width:1024px)"
                        />
                        <source
                          srcSet="https://eat-curious.com/wp-content/uploads/2023/07/negg-e1690228015512-1024x938.png"
                          media="(resolution: 192dpi) and (min-width:600px)"
                        />
                        <source
                          srcSet="https://eat-curious.com/wp-content/uploads/2023/07/negg-e1690228015512-768x704.png"
                          media="(resolution: 192dpi)"
                        />
                        <source
                          srcSet="https://eat-curious.com/wp-content/uploads/2023/07/negg-e1690228015512-768x704.png"
                        ...
                        <img
                          width="100%"
                          height="100%"
                          src="https://eat-curious.com/wp-content/uploads/2023/07/negg-e1690228015512-300x275.png"
                          alt="Negg"
                        />
                      </picture>
                    </div>
              ...
              >
                <div className="tile__content">
                  <h4>
                    <a href="https://eat-curious.com/products/tenders/">
                      Curious Tenders
                    </a>
                  </h4>
                  <h4>
                ...
                <div className="tile__track">
                  ...
                  >
                    <div className="tile__format">
                      <picture>
                        <source
                          srcSet="https://eat-curious.com/wp-content/uploads/2022/11/tenders-3-e1669377993231.png"
                          media="(resolution: 192dpi) and (min-width:1024px)"
                        />
                        <source
                          srcSet="https://eat-curious.com/wp-content/uploads/2022/11/tenders-3-e1669377993231-1024x1018.png"
                          media="(resolution: 192dpi) and (min-width:600px)"
                        />
                        <source
                          srcSet="https://eat-curious.com/wp-content/uploads/2022/11/tenders-3-e1669377993231-768x764.png"
                          media="(resolution: 192dpi)"
                        />
                        <source
                          srcSet="https://eat-curious.com/wp-content/uploads/2022/11/tenders-3-e1669377993231-768x764.png"
                        ...
                        <img
                          width="100%"
                          height="100%"
                          src="https://eat-curious.com/wp-content/uploads/2022/11/tenders-3-e1669377993231-300x298.png"
                          alt="Tenders 1"
                        />
                      </picture>
                    </div>
              ...
              <article
                className="tile appear delay"
                style={{ backgroundColor: "#F95B77" }}
              >
                <div className="tile__content">
                  <h4>
                    <a href="https://eat-curious.com/products/bangers/">
                      Curious Bangers
                    </a>
                  </h4>
                  <h4>
                ...
                <div className="tile__track">
                  ...
                  >
                    <div className="tile__format">
                      <picture>
                        <source
                          srcSet="https://eat-curious.com/wp-content/uploads/2022/11/bangers-2-e1668786923894.png"
                          media="(resolution: 192dpi) and (min-width:1024px)"
                        />
                        <source
                          srcSet="https://eat-curious.com/wp-content/uploads/2022/11/bangers-2-e1668786923894-830x1024.png"
                          media="(resolution: 192dpi) and (min-width:600px)"
                        />
                        <source
                          srcSet="https://eat-curious.com/wp-content/uploads/2022/11/bangers-2-e1668786923894-768x947.png"
                          media="(resolution: 192dpi)"
                        />
                        <source
                          srcSet="https://eat-curious.com/wp-content/uploads/2022/11/bangers-2-e1668786923894-768x947.png"
                        ...
                        <img
                          width="100%"
                          height="100%"
                          src="https://eat-curious.com/wp-content/uploads/2022/11/bangers-2-e1668786923894-243x300.png"
                          alt="Bangers"
                        />
                      </picture>
                    </div>
              ...
              >
                <div className="tile__content">
                  <h4>
                    <a href="https://eat-curious.com/products/fillets/">
                      Curious Fillets
                    </a>
                  </h4>
                  <h4>
                ...
                <div className="tile__track">
                  ...
                  >
                    <div className="tile__format">
                      <picture>
                        <source
                          srcSet="https://eat-curious.com/wp-content/uploads/2022/11/fillets-3.png"
                          media="(resolution: 192dpi) and (min-width:1024px)"
                        />
                        <source
                          srcSet="https://eat-curious.com/wp-content/uploads/2022/11/fillets-3-1024x1015.png"
                          media="(resolution: 192dpi) and (min-width:600px)"
                        />
                        <source
                          srcSet="https://eat-curious.com/wp-content/uploads/2022/11/fillets-3-768x761.png"
                          media="(resolution: 192dpi)"
                        />
                        <source
                          srcSet="https://eat-curious.com/wp-content/uploads/2022/11/fillets-3-768x761.png"
                        ...
                        <img
                          width="100%"
                          height="100%"
                          src="https://eat-curious.com/wp-content/uploads/2022/11/fillets-3-300x297.png"
                          alt="Fillets"
                        />
                      </picture>
                    </div>
              ...
              >
                <div className="tile__content">
                  <h4>
                    <a href="https://eat-curious.com/products/patty/">
                      Curious Pattie
                    </a>
                  </h4>
                  <h4>
                ...
                <div className="tile__track">
                  <a
                    href="https://eat-curious.com/products/patty/"
                    className="tile__image"
                  >
                    <div className="tile__format">
                      <picture>
                        <source
                          srcSet="https://eat-curious.com/wp-content/uploads/2022/11/patty-3-e1669121069255.png"
                          media="(resolution: 192dpi) and (min-width:1024px)"
                        />
                        <source
                          srcSet="https://eat-curious.com/wp-content/uploads/2022/11/patty-3-e1669121069255-1024x1021.png"
                          media="(resolution: 192dpi) and (min-width:600px)"
                        />
                        <source
                          srcSet="https://eat-curious.com/wp-content/uploads/2022/11/patty-3-e1669121069255-768x766.png"
                          media="(resolution: 192dpi)"
                        />
                        <source
                          srcSet="https://eat-curious.com/wp-content/uploads/2022/11/patty-3-e1669121069255-768x766.png"
                        ...
                        <img
                          width="100%"
                          height="100%"
                          src="https://eat-curious.com/wp-content/uploads/2022/11/patty-3-e1669121069255-300x300.png"
                          alt="Patty"
                        />
                      </picture>
                    </div>
              ...
              >
                <div className="tile__content">
                  <h4>
                    <a href="https://eat-curious.com/products/roast/">
                      Curious Roast
                    </a>
                  </h4>
                  <h4>
                ...
                <div className="tile__track">
                  ...
                  >
                    <div className="tile__format">
                      <picture>
                        <source
                          srcSet="https://eat-curious.com/wp-content/uploads/2022/11/roast-3-e1669376662878.png"
                          media="(resolution: 192dpi) and (min-width:1024px)"
                        />
                        <source
                          srcSet="https://eat-curious.com/wp-content/uploads/2022/11/roast-3-1024x926.png"
                          media="(resolution: 192dpi) and (min-width:600px)"
                        />
                        <source
                          srcSet="https://eat-curious.com/wp-content/uploads/2022/11/roast-3-e1669376662878-768x730.png"
                          media="(resolution: 192dpi)"
                        />
                        <source
                          srcSet="https://eat-curious.com/wp-content/uploads/2022/11/roast-3-e1669376662878-768x730.png"
                        ...
                        <img
                          width="100%"
                          height="100%"
                          src="https://eat-curious.com/wp-content/uploads/2022/11/roast-3-e1669376662878-300x285.png"
                          alt="Roast 1"
                        />
                      </picture>
                    </div>
              ...
              >
                <div className="tile__content">
                  <h4>
                    <a href="https://eat-curious.com/products/burger/">
                      Curious Burger
                    </a>
                  </h4>
                  <h4>
                ...
                <div className="tile__track">
                  ...
                  >
                    <div className="tile__format">
                      <picture>
                        <source
                          srcSet="https://eat-curious.com/wp-content/uploads/2022/11/burger-3.png"
                          media="(resolution: 192dpi) and (min-width:1024px)"
                        />
                        <source
                          srcSet="https://eat-curious.com/wp-content/uploads/2022/11/burger-3-1024x1019.png"
                          media="(resolution: 192dpi) and (min-width:600px)"
                        />
                        <source
                          srcSet="https://eat-curious.com/wp-content/uploads/2022/11/burger-3-768x764.png"
                          media="(resolution: 192dpi)"
                        />
                        <source
                          srcSet="https://eat-curious.com/wp-content/uploads/2022/11/burger-3-768x764.png"
                        ...
                        <img
                          width="100%"
                          height="100%"
                          src="https://eat-curious.com/wp-content/uploads/2022/11/burger-3-300x298.png"
                          alt="Burger 3"
                        />
                      </picture>
                    </div>
              ...
              >
                <div className="tile__content">
                  <h4>
                    <a href="https://eat-curious.com/products/block/">
                      Curious Block
                    </a>
                  </h4>
                  <h4>
                ...
                <div className="tile__track">
                  ...
                  >
                    <div className="tile__format">
                      <picture>
                        <source
                          srcSet="https://eat-curious.com/wp-content/uploads/2022/11/block.png"
                          media="(resolution: 192dpi) and (min-width:1024px)"
                        />
                        <source
                          srcSet="https://eat-curious.com/wp-content/uploads/2022/11/block.png"
                        ...
                        <img
                          width="100%"
                          height="100%"
                          src="https://eat-curious.com/wp-content/uploads/2022/11/block-300x151.png"
                          alt="Block 1"
                        />
                      </picture>
                    </div>
              ...
              <div className="tile tile--spacer" />
            </div>
            <p className="center appear delay">
              <br />
              <a className="button" href="https://eat-curious.com/products/">
                View All
              </a>
              <br />
            </p>
          </section>
          <section className="text-and-image full" data-watch="true">
            <div className="text-and-image__text wysiwyg appear delay">
              <h4>We're growing more than plants...</h4>
              <p>
                We’re here to grow a positive, curious and thoughtful attitude
                to plant-based food. Which is why we put curiosity at the heart
                of everything we do. So much so, we’ve built our own vertical
                farm – a near-off-grid, plant playground where we’re researching
                how to add even more flavour, nutrition and sustainability to
                the way we all eat.
              </p>
              <p>&nbsp;</p>
              <p>
                <a className="button" href="https://syanfarms.com/">
                  Visit Syan Farms
                </a>
              </p>
            </div>
            <div className="text-and-image__half appear delay">
              <img
                width={1024}
                height={576}
                ...
                alt="Home 58"
                decoding="async"
                srcSet="https://eat-curious.com/wp-content/uploads/2023/07/home-54-1024x576.jpg 1024w, https://eat-curious.com/wp-content/uploads/2023/07/home-54-300x169.jpg 300w, https://eat-curious.com/wp-content/uploads/2023/07/home-54-473x266.jpg 473w, https://eat-curious.com/wp-content/uploads/2023/07/home-54-768x432.jpg 768w"
                sizes="(max-width: 1024px) 100vw, 1024px"
              />{" "}
            </div>
          </section>
          <section
            id="recipes"
            className="recipes full swiper"
            data-watch="true"
          >
            <div className="recipes__wrapper swiper-wrapper">
              <article className="recipe appear delay">
                <div className="recipe__cover">
                  <h4>
                    <span style={{ recipeFontSize: "-90px" }} />
                  </h4>
                  <img
                    width={2500}
                    height={1767}
                    src="https://eat-curious.com/wp-content/uploads/2023/07/afro-fusion-spice-bowl.jpg"
                    className="attachment-post-thumbnail size-post-thumbnail wp-post-image"
                    alt="afro-fusion      spice bowl"
                    decoding="async"
                    srcSet="https://eat-curious.com/wp-content/uploads/2023/07/afro-fusion-spice-bowl.jpg 2500w, https://eat-curious.com/wp-content/uploads/2023/07/afro-fusion-spice-bowl-300x212.jpg 300w, https://eat-curious.com/wp-content/uploads/2023/07/afro-fusion-spice-bowl-473x334.jpg 473w, https://eat-curious.com/wp-content/uploads/2023/07/afro-fusion-spice-bowl-768x543.jpg 768w, https://eat-curious.com/wp-content/uploads/2023/07/afro-fusion-spice-bowl-1024x724.jpg 1024w"
                    sizes="(max-width: 2500px) 100vw, 2500px"
                  />{" "}
                  <span className="tag" style={{ backgroundColor: "#FFB500" }}>
                    Mince
                  </span>{" "}
                </div>
                <div className="recipe__details">
                  ...
                  <div className="tabs">
                    <div className="tabs__buttons">
                      <button
                        id="555-ingredients-tab"
                        className="tabs__tab"
                        aria-expanded="true"
                        aria-controls="555-ingredients"
                      >
                        Ingredients
                      </button>
                      <button
                        ...
                        className="tabs__tab"
                        aria-expanded="false"
                        aria-controls="555-steps"
                      >
                        Steps
                      </button>
                    </div>
                    <div
                      data-name="555-ingredients"
                      className="tabs__region tab--ingredients"
                      role="region"
                      aria-expanded="true"
                      aria-labelledby="555-ingredients-tab"
                    >
                      <div className="tabs__wrap">N/A </div>
                    </div>
                  </div>
                </div>
              </article>
              <article className="recipe appear delay">
                <div className="recipe__cover">
                  ...
                  <img
                    width={2500}
                    height={1753}
                    src="https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-2.jpg"
                    className="attachment-post-thumbnail size-post-thumbnail wp-post-image"
                    alt="Auto Draft 1"
                    decoding="async"
                    srcSet="https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-2.jpg 2500w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-2-300x210.jpg 300w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-2-473x332.jpg 473w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-2-768x539.jpg 768w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-2-1024x718.jpg 1024w"
                    sizes="(max-width: 2500px) 100vw, 2500px"
                  />{" "}
                  <span className="tag" style={{ backgroundColor: "#1ABE71" }}>
                    Tenders
                  </span>{" "}
                </div>
                <div className="recipe__details">
                  ...
                  <div className="tabs">
                    <div className="tabs__buttons">
                      <button
                        id="565-ingredients-tab"
                        className="tabs__tab"
                        aria-expanded="true"
                        aria-controls="565-ingredients"
                      >
                        Ingredients
                      </button>
                      <button
                        ...
                        className="tabs__tab"
                        aria-expanded="false"
                        aria-controls="565-steps"
                      >
                        Steps
                      </button>
                    </div>
                    <div
                      data-name="565-ingredients"
                      className="tabs__region tab--ingredients"
                      role="region"
                      aria-expanded="true"
                      aria-labelledby="565-ingredients-tab"
                    >
                      <div className="tabs__wrap">N/A </div>
                    </div>
                  </div>
              ...
              <article className="recipe appear delay">
                <div className="recipe__cover">
                  ...
                  <img
                    width={2500}
                    height={1767}
                    src="https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-3.jpg"
                    className="attachment-post-thumbnail size-post-thumbnail wp-post-image"
                    alt="Auto Draft 2"
                    decoding="async"
                    srcSet="https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-3.jpg 2500w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-3-300x212.jpg 300w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-3-473x334.jpg 473w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-3-768x543.jpg 768w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-3-1024x724.jpg 1024w"
                    sizes="(max-width: 2500px) 100vw, 2500px"
                  />{" "}
                  <span className="tag" style={{ backgroundColor: "#1ABE71" }}>
                    Fillets
                ...
                <div className="recipe__details">
                  ...
                  <div className="tabs">
                    <div className="tabs__buttons">
                      <button
                        id="568-ingredients-tab"
                        className="tabs__tab"
                        aria-expanded="true"
                        aria-controls="568-ingredients"
                      >
                        Ingredients
                      </button>
                      <button
                        ...
                        className="tabs__tab"
                        aria-expanded="false"
                        aria-controls="568-steps"
                      >
                        Steps
                      </button>
                    </div>
                    <div
                      data-name="568-ingredients"
                      className="tabs__region tab--ingredients"
                      role="region"
                      aria-expanded="true"
                      aria-labelledby="568-ingredients-tab"
                    >
                      <div className="tabs__wrap">N/A </div>
                    </div>
                  </div>
              ...
              <article className="recipe appear delay">
                <div className="recipe__cover">
                  ...
                  <img
                    width={2500}
                    height={1767}
                    src="https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-4.jpg"
                    className="attachment-post-thumbnail size-post-thumbnail wp-post-image"
                    alt="Auto Draft 3"
                    decoding="async"
                    srcSet="https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-4.jpg 2500w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-4-300x212.jpg 300w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-4-473x334.jpg 473w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-4-768x543.jpg 768w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-4-1024x724.jpg 1024w"
                    sizes="(max-width: 2500px) 100vw, 2500px"
                  />{" "}
                  <span className="tag" style={{ backgroundColor: "#F95B77" }}>
                    Bangers
                  </span>{" "}
                </div>
                <div className="recipe__details">
                  ...
                  <div className="tabs">
                    <div className="tabs__buttons">
                      <button
                        id="587-ingredients-tab"
                        className="tabs__tab"
                        aria-expanded="true"
                        aria-controls="587-ingredients"
                      >
                        Ingredients
                      </button>
                      <button
                        ...
                        className="tabs__tab"
                        aria-expanded="false"
                        aria-controls="587-steps"
                      >
                        Steps
                      </button>
                    </div>
                    <div
                      data-name="587-ingredients"
                      className="tabs__region tab--ingredients"
                      role="region"
                      aria-expanded="true"
                      aria-labelledby="587-ingredients-tab"
                    >
                      <div className="tabs__wrap">N/A </div>
                    </div>
                  </div>
              ...
              <article className="recipe appear delay">
                <div className="recipe__cover">
                  ...
                  <img
                    width={2500}
                    height={1767}
                    src="https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-5.jpg"
                    className="attachment-post-thumbnail size-post-thumbnail wp-post-image"
                    alt="Auto Draft 4"
                    decoding="async"
                    srcSet="https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-5.jpg 2500w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-5-300x212.jpg 300w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-5-473x334.jpg 473w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-5-768x543.jpg 768w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-5-1024x724.jpg 1024w"
                    sizes="(max-width: 2500px) 100vw, 2500px"
                  />{" "}
                  <span className="tag" style={{ backgroundColor: "#1ABE71" }}>
                    Tenders
                ...
                <div className="recipe__details">
                  ...
                  <div className="tabs">
                    <div className="tabs__buttons">
                      <button
                        id="589-ingredients-tab"
                        className="tabs__tab"
                        aria-expanded="true"
                        aria-controls="589-ingredients"
                      >
                        Ingredients
                      </button>
                      <button
                        ...
                        className="tabs__tab"
                        aria-expanded="false"
                        aria-controls="589-steps"
                      >
                        Steps
                      </button>
                    </div>
                    <div
                      data-name="589-ingredients"
                      className="tabs__region tab--ingredients"
                      role="region"
                      aria-expanded="true"
                      aria-labelledby="589-ingredients-tab"
                    >
                      <div className="tabs__wrap">N/A </div>
                    </div>
                  </div>
              ...
              <article className="recipe appear delay">
                <div className="recipe__cover">
                  ...
                  <img
                    width={2500}
                    height={1766}
                    src="https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-6.jpg"
                    className="attachment-post-thumbnail size-post-thumbnail wp-post-image"
                    alt="Auto Draft 5"
                    decoding="async"
                    srcSet="https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-6.jpg 2500w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-6-300x212.jpg 300w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-6-473x334.jpg 473w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-6-768x543.jpg 768w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-6-1024x723.jpg 1024w"
                    sizes="(max-width: 2500px) 100vw, 2500px"
                  />{" "}
                  <span className="tag" style={{ backgroundColor: "#1ABE71" }}>
                    Pieces
                ...
                <div className="recipe__details">
                  ...
                  <div className="tabs">
                    <div className="tabs__buttons">
                      <button
                        id="591-ingredients-tab"
                        className="tabs__tab"
                        aria-expanded="true"
                        aria-controls="591-ingredients"
                      >
                        Ingredients
                      </button>
                      <button
                        ...
                        className="tabs__tab"
                        aria-expanded="false"
                        aria-controls="591-steps"
                      >
                        Steps
                      </button>
                    </div>
                    <div
                      data-name="591-ingredients"
                      className="tabs__region tab--ingredients"
                      role="region"
                      aria-expanded="true"
                      aria-labelledby="591-ingredients-tab"
                    >
                      <div className="tabs__wrap">N/A </div>
                    </div>
                  </div>
              ...
              <article className="recipe appear delay">
                <div className="recipe__cover">
                  ...
                  <img
                    width={2500}
                    height={1767}
                    src="https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-7.jpg"
                    className="attachment-post-thumbnail size-post-thumbnail wp-post-image"
                    alt="Auto Draft 6"
                    decoding="async"
                    srcSet="https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-7.jpg 2500w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-7-300x212.jpg 300w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-7-473x334.jpg 473w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-7-768x543.jpg 768w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-7-1024x724.jpg 1024w"
                    sizes="(max-width: 2500px) 100vw, 2500px"
                  />{" "}
                  <span className="tag" style={{ backgroundColor: "#1ABE71" }}>
                    Fillets
                ...
                <div className="recipe__details">
                  ...
                  <div className="tabs">
                    <div className="tabs__buttons">
                      <button
                        id="593-ingredients-tab"
                        className="tabs__tab"
                        aria-expanded="true"
                        aria-controls="593-ingredients"
                      >
                        Ingredients
                      </button>
                      <button
                        ...
                        className="tabs__tab"
                        aria-expanded="false"
                        aria-controls="593-steps"
                      >
                        Steps
                      </button>
                    </div>
                    <div
                      data-name="593-ingredients"
                      className="tabs__region tab--ingredients"
                      role="region"
                      aria-expanded="true"
                      aria-labelledby="593-ingredients-tab"
                    >
                      <div className="tabs__wrap">N/A </div>
                    </div>
                  </div>
              ...
              <article className="recipe appear delay">
                <div className="recipe__cover">
                  ...
                  <img
                    width={2500}
                    height={1767}
                    src="https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-8.jpg"
                    className="attachment-post-thumbnail size-post-thumbnail wp-post-image"
                    alt="Auto Draft 7"
                    decoding="async"
                    srcSet="https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-8.jpg 2500w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-8-300x212.jpg 300w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-8-473x334.jpg 473w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-8-768x543.jpg 768w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-8-1024x724.jpg 1024w"
                    sizes="(max-width: 2500px) 100vw, 2500px"
                  />{" "}
                  <span className="tag" style={{ backgroundColor: "#1ABE71" }}>
                    Tenders
                ...
                <div className="recipe__details">
                  ...
                  <div className="tabs">
                    <div className="tabs__buttons">
                      <button
                        id="595-ingredients-tab"
                        className="tabs__tab"
                        aria-expanded="true"
                        aria-controls="595-ingredients"
                      >
                        Ingredients
                      </button>
                      <button
                        ...
                        className="tabs__tab"
                        aria-expanded="false"
                        aria-controls="595-steps"
                      >
                        Steps
                      </button>
                    </div>
                    <div
                      data-name="595-ingredients"
                      className="tabs__region tab--ingredients"
                      role="region"
                      aria-expanded="true"
                      aria-labelledby="595-ingredients-tab"
                    >
                      <div className="tabs__wrap">N/A </div>
                    </div>
                  </div>
              ...
              <article className="recipe appear delay">
                <div className="recipe__cover">
                  ...
                  <img
                    width={2500}
                    height={1767}
                    src="https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-9.jpg"
                    className="attachment-post-thumbnail size-post-thumbnail wp-post-image"
                    alt="Auto Draft 8"
                    decoding="async"
                    srcSet="https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-9.jpg 2500w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-9-300x212.jpg 300w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-9-473x334.jpg 473w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-9-768x543.jpg 768w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-9-1024x724.jpg 1024w"
                    sizes="(max-width: 2500px) 100vw, 2500px"
                  />{" "}
                  <span className="tag" style={{ backgroundColor: "#1ABE71" }}>
                    Pieces
                ...
                <div className="recipe__details">
                  ...
                  <div className="tabs">
                    <div className="tabs__buttons">
                      <button
                        id="597-ingredients-tab"
                        className="tabs__tab"
                        aria-expanded="true"
                        aria-controls="597-ingredients"
                      >
                        Ingredients
                      </button>
                      <button
                        ...
                        className="tabs__tab"
                        aria-expanded="false"
                        aria-controls="597-steps"
                      >
                        Steps
                      </button>
                    </div>
                    <div
                      data-name="597-ingredients"
                      className="tabs__region tab--ingredients"
                      role="region"
                      aria-expanded="true"
                      aria-labelledby="597-ingredients-tab"
                    >
                      <div className="tabs__wrap">N/A </div>
                    </div>
                  </div>
              ...
              <article className="recipe appear delay">
                <div className="recipe__cover">
                  ...
                  <img
                    width={2500}
                    height={1755}
                    src="https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-10.jpg"
                    className="attachment-post-thumbnail size-post-thumbnail wp-post-image"
                    alt="Auto Draft 9"
                    decoding="async"
                    srcSet="https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-10.jpg 2500w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-10-300x211.jpg 300w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-10-473x332.jpg 473w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-10-768x539.jpg 768w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-10-1024x719.jpg 1024w"
                    sizes="(max-width: 2500px) 100vw, 2500px"
                  />{" "}
                  <span className="tag" style={{ backgroundColor: "#1ABE71" }}>
                    Pieces
                ...
                <div className="recipe__details">
                  ...
                  <div className="tabs">
                    <div className="tabs__buttons">
                      <button
                        id="599-ingredients-tab"
                        className="tabs__tab"
                        aria-expanded="true"
                        aria-controls="599-ingredients"
                      >
                        Ingredients
                      </button>
                      <button
                        ...
                        className="tabs__tab"
                        aria-expanded="false"
                        aria-controls="599-steps"
                      >
                        Steps
                      </button>
                    </div>
                    <div
                      data-name="599-ingredients"
                      className="tabs__region tab--ingredients"
                      role="region"
                      aria-expanded="true"
                      aria-labelledby="599-ingredients-tab"
                    >
                      <div className="tabs__wrap">N/A </div>
                    </div>
                  </div>
              ...
              <article className="recipe appear delay">
                <div className="recipe__cover">
                  ...
                  <img
                    width={2500}
                    height={1767}
                    src="https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-11.jpg"
                    className="attachment-post-thumbnail size-post-thumbnail wp-post-image"
                    alt="Auto Draft 10"
                    decoding="async"
                    srcSet="https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-11.jpg 2500w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-11-300x212.jpg 300w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-11-473x334.jpg 473w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-11-768x543.jpg 768w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-11-1024x724.jpg 1024w"
                    sizes="(max-width: 2500px) 100vw, 2500px"
                  />{" "}
                  <span className="tag" style={{ backgroundColor: "#1ABE71" }}>
                    Tenders
                ...
                <div className="recipe__details">
                  ...
                  <div className="tabs">
                    <div className="tabs__buttons">
                      <button
                        id="601-ingredients-tab"
                        className="tabs__tab"
                        aria-expanded="true"
                        aria-controls="601-ingredients"
                      >
                        Ingredients
                      </button>
                      <button
                        ...
                        className="tabs__tab"
                        aria-expanded="false"
                        aria-controls="601-steps"
                      >
                        Steps
                      </button>
                    </div>
                    <div
                      data-name="601-ingredients"
                      className="tabs__region tab--ingredients"
                      role="region"
                      aria-expanded="true"
                      aria-labelledby="601-ingredients-tab"
                    >
                      <div className="tabs__wrap">N/A </div>
                    </div>
                  </div>
              ...
              <article className="recipe appear delay">
                <div className="recipe__cover">
                  ...
                  <img
                    width={2500}
                    height={1768}
                    src="https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-12.jpg"
                    className="attachment-post-thumbnail size-post-thumbnail wp-post-image"
                    alt="Auto Draft 11"
                    decoding="async"
                    srcSet="https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-12.jpg 2500w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-12-300x212.jpg 300w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-12-473x335.jpg 473w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-12-768x543.jpg 768w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-12-1024x724.jpg 1024w"
                    sizes="(max-width: 2500px) 100vw, 2500px"
                  />{" "}
                  <span className="tag" style={{ backgroundColor: "#1ABE71" }}>
                    Pieces
                ...
                <div className="recipe__details">
                  ...
                  <div className="tabs">
                    <div className="tabs__buttons">
                      <button
                        id="603-ingredients-tab"
                        className="tabs__tab"
                        aria-expanded="true"
                        aria-controls="603-ingredients"
                      >
                        Ingredients
                      </button>
                      <button
                        ...
                        className="tabs__tab"
                        aria-expanded="false"
                        aria-controls="603-steps"
                      >
                        Steps
                      </button>
                    </div>
                    <div
                      data-name="603-ingredients"
                      className="tabs__region tab--ingredients"
                      role="region"
                      aria-expanded="true"
                      aria-labelledby="603-ingredients-tab"
                    >
                      <div className="tabs__wrap">N/A </div>
                    </div>
                  </div>
              ...
              <article className="recipe appear delay">
                <div className="recipe__cover">
                  ...
                  <img
                    width={2500}
                    height={1724}
                    src="https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-13.jpg"
                    className="attachment-post-thumbnail size-post-thumbnail wp-post-image"
                    alt="Auto Draft 12"
                    decoding="async"
                    srcSet="https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-13.jpg 2500w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-13-300x207.jpg 300w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-13-473x326.jpg 473w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-13-768x530.jpg 768w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-13-1024x706.jpg 1024w"
                    sizes="(max-width: 2500px) 100vw, 2500px"
                  />{" "}
                  <span className="tag" style={{ backgroundColor: "#1ABE71" }}>
                    Pieces
                ...
                <div className="recipe__details">
                  ...
                  <div className="tabs">
                    <div className="tabs__buttons">
                      <button
                        id="605-ingredients-tab"
                        className="tabs__tab"
                        aria-expanded="true"
                        aria-controls="605-ingredients"
                      >
                        Ingredients
                      </button>
                      <button
                        ...
                        className="tabs__tab"
                        aria-expanded="false"
                        aria-controls="605-steps"
                      >
                        Steps
                      </button>
                    </div>
                    <div
                      data-name="605-ingredients"
                      className="tabs__region tab--ingredients"
                      role="region"
                      aria-expanded="true"
                      aria-labelledby="605-ingredients-tab"
                    >
                      <div className="tabs__wrap">N/A </div>
                    </div>
                  </div>
              ...
              <article className="recipe appear delay">
                <div className="recipe__cover">
                  ...
                  <img
                    width={2500}
                    height={1767}
                    src="https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-14.jpg"
                    className="attachment-post-thumbnail size-post-thumbnail wp-post-image"
                    alt="Auto Draft 13"
                    decoding="async"
                    srcSet="https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-14.jpg 2500w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-14-300x212.jpg 300w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-14-473x334.jpg 473w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-14-768x543.jpg 768w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-14-1024x724.jpg 1024w"
                    sizes="(max-width: 2500px) 100vw, 2500px"
                  />{" "}
                  <span className="tag" style={{ backgroundColor: "#F95B77" }}>
                    Pattie
                ...
                <div className="recipe__details">
                  ...
                  <div className="tabs">
                    <div className="tabs__buttons">
                      <button
                        id="607-ingredients-tab"
                        className="tabs__tab"
                        aria-expanded="true"
                        aria-controls="607-ingredients"
                      >
                        Ingredients
                      </button>
                      <button
                        ...
                        className="tabs__tab"
                        aria-expanded="false"
                        aria-controls="607-steps"
                      >
                        Steps
                      </button>
                    </div>
                    <div
                      data-name="607-ingredients"
                      className="tabs__region tab--ingredients"
                      role="region"
                      aria-expanded="true"
                      aria-labelledby="607-ingredients-tab"
                    >
                      <div className="tabs__wrap">N/A </div>
                    </div>
                  </div>
              ...
              <article className="recipe appear delay">
                <div className="recipe__cover">
                  ...
                  <img
                    width={2500}
                    height={1767}
                    src="https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-15.jpg"
                    className="attachment-post-thumbnail size-post-thumbnail wp-post-image"
                    alt="Auto Draft 14"
                    decoding="async"
                    srcSet="https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-15.jpg 2500w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-15-300x212.jpg 300w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-15-473x334.jpg 473w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-15-768x543.jpg 768w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-15-1024x724.jpg 1024w"
                    sizes="(max-width: 2500px) 100vw, 2500px"
                  />{" "}
                  <span className="tag" style={{ backgroundColor: "#FFB500" }}>
                    Mince
                ...
                <div className="recipe__details">
                  ...
                  <div className="tabs">
                    <div className="tabs__buttons">
                      <button
                        id="609-ingredients-tab"
                        className="tabs__tab"
                        aria-expanded="true"
                        aria-controls="609-ingredients"
                      >
                        Ingredients
                      </button>
                      <button
                        ...
                        className="tabs__tab"
                        aria-expanded="false"
                        aria-controls="609-steps"
                      >
                        Steps
                      </button>
                    </div>
                    <div
                      data-name="609-ingredients"
                      className="tabs__region tab--ingredients"
                      role="region"
                      aria-expanded="true"
                      aria-labelledby="609-ingredients-tab"
                    >
                      <div className="tabs__wrap">N/A </div>
                    </div>
                  </div>
              ...
              <article className="recipe appear delay">
                <div className="recipe__cover">
                  ...
                  <img
                    width={2500}
                    height={1757}
                    src="https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-16.jpg"
                    className="attachment-post-thumbnail size-post-thumbnail wp-post-image"
                    alt="Auto Draft 15"
                    decoding="async"
                    srcSet="https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-16.jpg 2500w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-16-300x211.jpg 300w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-16-473x332.jpg 473w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-16-768x540.jpg 768w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-16-1024x720.jpg 1024w"
                    sizes="(max-width: 2500px) 100vw, 2500px"
                  />{" "}
                  <span className="tag" style={{ backgroundColor: "#FFB500" }}>
                    Mince
                ...
                <div className="recipe__details">
                  ...
                  <div className="tabs">
                    <div className="tabs__buttons">
                      <button
                        id="611-ingredients-tab"
                        className="tabs__tab"
                        aria-expanded="true"
                        aria-controls="611-ingredients"
                      >
                        Ingredients
                      </button>
                      <button
                        ...
                        className="tabs__tab"
                        aria-expanded="false"
                        aria-controls="611-steps"
                      >
                        Steps
                      </button>
                    </div>
                    <div
                      data-name="611-ingredients"
                      className="tabs__region tab--ingredients"
                      role="region"
                      aria-expanded="true"
                      aria-labelledby="611-ingredients-tab"
                    >
                      <div className="tabs__wrap">N/A </div>
                    </div>
                  </div>
              ...
              <article className="recipe appear delay">
                <div className="recipe__cover">
                  ...
                  <img
                    width={2500}
                    height={1755}
                    src="https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-17.jpg"
                    className="attachment-post-thumbnail size-post-thumbnail wp-post-image"
                    alt="Auto Draft 16"
                    decoding="async"
                    srcSet="https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-17.jpg 2500w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-17-300x211.jpg 300w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-17-473x332.jpg 473w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-17-768x539.jpg 768w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-17-1024x719.jpg 1024w"
                    sizes="(max-width: 2500px) 100vw, 2500px"
                  />{" "}
                  <span className="tag" style={{ backgroundColor: "#1ABE71" }}>
                    Pieces
                ...
                <div className="recipe__details">
                  ...
                  <div className="tabs">
                    <div className="tabs__buttons">
                      <button
                        id="613-ingredients-tab"
                        className="tabs__tab"
                        aria-expanded="true"
                        aria-controls="613-ingredients"
                      >
                        Ingredients
                      </button>
                      <button
                        ...
                        className="tabs__tab"
                        aria-expanded="false"
                        aria-controls="613-steps"
                      >
                        Steps
                      </button>
                    </div>
                    <div
                      data-name="613-ingredients"
                      className="tabs__region tab--ingredients"
                      role="region"
                      aria-expanded="true"
                      aria-labelledby="613-ingredients-tab"
                    >
                      <div className="tabs__wrap">N/A </div>
                    </div>
                  </div>
              ...
              <article className="recipe appear delay">
                <div className="recipe__cover">
                  ...
                  <img
                    width={2500}
                    height={1756}
                    src="https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-19.jpg"
                    className="attachment-post-thumbnail size-post-thumbnail wp-post-image"
                    alt="Auto Draft 18"
                    decoding="async"
                    srcSet="https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-19.jpg 2500w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-19-300x211.jpg 300w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-19-473x332.jpg 473w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-19-768x539.jpg 768w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-19-1024x719.jpg 1024w"
                    sizes="(max-width: 2500px) 100vw, 2500px"
                  />{" "}
                  <span className="tag" style={{ backgroundColor: "#FFB500" }}>
                    Mince
                ...
                <div className="recipe__details">
                  ...
                  <div className="tabs">
                    <div className="tabs__buttons">
                      <button
                        id="615-ingredients-tab"
                        className="tabs__tab"
                        aria-expanded="true"
                        aria-controls="615-ingredients"
                      >
                        Ingredients
                      </button>
                      <button
                        ...
                        className="tabs__tab"
                        aria-expanded="false"
                        aria-controls="615-steps"
                      >
                        Steps
                      </button>
                    </div>
                    <div
                      data-name="615-ingredients"
                      className="tabs__region tab--ingredients"
                      role="region"
                      aria-expanded="true"
                      aria-labelledby="615-ingredients-tab"
                    >
                      <div className="tabs__wrap">N/A </div>
                    </div>
                  </div>
              ...
              <article className="recipe appear delay">
                <div className="recipe__cover">
                  ...
                  <img
                    width={2400}
                    height={2400}
                    src="https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-20.jpg"
                    className="attachment-post-thumbnail size-post-thumbnail wp-post-image"
                    alt="Auto Draft 19"
                    decoding="async"
                    srcSet="https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-20.jpg 2400w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-20-1200x1200.jpg 1200w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-20-600x600.jpg 600w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-20-300x300.jpg 300w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-20-473x473.jpg 473w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-20-768x768.jpg 768w, https://eat-curious.com/wp-content/uploads/2023/07/auto-draft-20-1024x1024.jpg 1024w"
                ...
                <div className="recipe__details">
                  ...
                  <div className="tabs">
                    <div className="tabs__buttons">
                      <button
                        id="617-ingredients-tab"
                        className="tabs__tab"
                        aria-expanded="true"
                        aria-controls="617-ingredients"
                      >
                        Ingredients
                      </button>
                      <button
                        ...
                        className="tabs__tab"
                        aria-expanded="false"
                        aria-controls="617-steps"
                      >
                        Steps
                      </button>
                    </div>
                    <div
                      data-name="617-ingredients"
                      className="tabs__region tab--ingredients"
                      role="region"
                      aria-expanded="true"
                      aria-labelledby="617-ingredients-tab"
                    >
                      <div className="tabs__wrap">N/A </div>
                    </div>
                  </div>
        ...
        <section className="contact nav-dark" data-watch="true">
          <div className="contact__wrapper">
            <div className="contain wysiwyg appear">
              <h3>Intrigued?</h3>
              <p>
                <a className="button" href="https://eat-curious.com/contact/">
                  let’s chat
                </a>
              </p>
            </div>
            <img
              className="contact__image lazy--placeholder"
              data-src="https://eat-curious.com/wp-content/uploads/2022/12/home-6.svg"
              src="https://eat-curious.com/wp-content/uploads/2022/12/home-6.svg"
              alt="Home 4"
            />
          </div>
        </section>
        <footer id="colophon" role="contentinfo" data-watch="true">
          <div className="full footer__content footer__content--first">
            ...
            >
              <div className="gform_heading">
                <h2 className="gform_title">Email Signup</h2>
              ...
              >
                <div
                  className="gf_invisible ginput_recaptchav3"
                  data-sitekey="6LcMlEwpAAAAABm5cK0aLQZsBB8zmzPMC4dphacS"
                  data-tabindex={0}
                >
                  <input
                    id="input_499af4f4251aece3cdc8eda658648292"
                    className="gfield_recaptcha_response"
                    type="hidden"
                    name="input_499af4f4251aece3cdc8eda658648292"
                    defaultValue
                  />
                </div>
                <div className="gform-body gform_body">
                  ...
                  >
                    <fieldset
                      id="field_1_3"
                      className="gfield gfield--type-name gfield--width-half gfield_contains_required field_sublabel_hidden_label gfield--no-description field_description_below hidden_label gfield_visibility_visible"
                    ...
                    >
                      ...
                      <div
                        className="ginput_complex ginput_container ginput_container--name no_prefix has_first_name no_middle_name no_last_name no_suffix gf_name_has_1 ginput_container_name gform-grid-row"
                        id="input_1_3"
                      >
                        <span
                          id="input_1_3_3_container"
                        ...
                        >
                          ...
                          <label
                            htmlFor="input_1_3_3"
                            className="gform-field-label gform-field-label--type-sub hidden_sub_label screen-reader-text"
                          >
                            First
                          </label>
                        </span>
                    ...
                    <div
                      id="field_1_4"
                      className="gfield gfield--type-email gfield--width-half gfield_contains_required field_sublabel_below gfield--no-description field_description_below hidden_label gfield_visibility_visible"
                ...
                <div className="gform_footer top_label">
                  ...
                  <input
                    ...
                    className="gform_hidden"
                    name="state_1"
                    defaultValue="WyJbXSIsIjg3ODMwNjQwODNhMzMxMzdiYTliMGNjNGFmMTIyMDNmIl0="
                  />
                  <input
                    type="hidden"
                    className="gform_hidden"
          ...
          <div className="full footer__content footer__content--last">
            ...
            <ul id="menu-footer" className="footer__menu">
              <li
                id="menu-item-492"
                className="menu-item menu-item-type-post_type menu-item-object-page menu-item-privacy-policy menu-item-492"
              >
                <a
                  rel="privacy-policy"
                  href="https://eat-curious.com/privacy-policy/"
                >
                  Privacy Policy
                </a>
              </li>
            ...
            <div className="footer__credits">
              <p className="site-credit caps">© Eat Curious 2024</p>
              <p className="site-credit site-credit--fiasco caps">
                <a href="https://fiasco.design" target="_blank" rel="nofollow">
                  Designed by Fiasco Design
                </a>
              </p>
            </div>
          </div>
